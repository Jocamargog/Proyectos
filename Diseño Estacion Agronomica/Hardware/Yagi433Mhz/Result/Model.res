...
lifetime=s:rebuild
result=s:1
files=s:Realized Gain,3D,Max. Value (Solid Angle).rd1
...
lifetime=s:surviveparchange
result=s:1
treepath=s:Tables\1D Results\Realized Gain,3D,Max. Value (Solid Angle)
files=s:Realized Gain,3D,Max. Value (Solid Angle).rt1
files=s:Realized Gain,3D,Max. Value (Solid Angle).rd1
...
lifetime=s:rebuild
result=s:1
treepath=s:Farfields\farfield (f=0.433) [1]
files=s:farfield (f=0.433)_1.ffm
ylabel=s:farfield (f=0.433) [1]
